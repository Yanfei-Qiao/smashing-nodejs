...
var gruntBySingleFile = {
	...
	// 总最外层目录一级一级检查destPath指定的目录是否存在
	// 如不存在则不断创建子目录，直至该创建文件时调用回调函数
